<?php
/**
 * Base class for widget and shortcode controls.
 * 
 * @package    D3WordCloud
 * @author     Crystal Barton <atrus1701@gmail.com>
 */

if( !class_exists('D3WordCloud_WidgetShortcodeControl_Base') ):

class D3WordCloud_WidgetShortcodeControl_Base extends WP_Widget
{
	/**
	...
	{
		die('function D3WordCloud_WidgetShortcodeControl_Base::print_widget_form() must be over-ridden in a sub-class.');
	}
	...
	{
		die('function D3WordCloud_WidgetShortcodeControl_Base::print_control() must be over-ridden in a sub-class.');
	}
}
